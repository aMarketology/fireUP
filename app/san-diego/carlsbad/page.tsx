...
export default function CarlsbadPage() {
  return (
    <div className="min-h-screen bg-zinc-950">
      ...
      <section className="relative min-h-[60vh] flex items-center overflow-hidden bg-zinc-950 pt-20">
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-gradient-to-b from-black/70 via-black/50 to-zinc-950">
            <img src="/hero-bg-hibachi.jpg" alt="Hibachi Catering Carlsbad" className="w-full h-full object-cover opacity-25" />
          </div>
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-8 py-20">
          <nav className="mb-6 text-sm text-zinc-500" aria-label="Breadcrumb">
            ...
            <span className="mx-2">›</span>
            <span className="text-zinc-300">Carlsbad</span>
          </nav>
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-zinc-800 bg-zinc-900/50 mb-6">
            ...
            <span className="text-xs font-medium text-zinc-400 uppercase tracking-widest">Carlsbad, San Diego County</span>
          </div>

          <h1 className="text-5xl md:text-6xl font-light text-zinc-100 leading-tight mb-4">
            Hibachi Catering in<br />
            <span className="bg-gradient-to-r from-red-500 to-red-700 bg-clip-text text-transparent font-normal">Carlsbad, CA</span>
          </h1>

          <p className="text-xl text-zinc-300 max-w-2xl mb-8 leading-relaxed font-light">
            Premium private hibachi catering for Carlsbad's most memorable events. Chef Hernan brings 14 years of professional teppanyaki experience to your Carlsbad home, resort, or corporate venue.
          </p>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-6">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-zinc-800 bg-zinc-900/50">
              <span className="text-xs font-medium text-zinc-400 uppercase tracking-widest">Why Carlsbad Chooses Us</span>
            </div>
            <h2 className="text-4xl font-bold text-zinc-100">
              Private Hibachi Chef for<br />
              <span className="bg-gradient-to-r from-red-500 to-red-600 bg-clip-text text-transparent">Carlsbad Events</span>
            </h2>
            <p className="text-zinc-400 text-lg leading-relaxed">
              Carlsbad is a hub for corporate headquarters, resort hotels, and upscale residential communities — all of which have hosted Fire Up Hibachi events. Whether it's a team building dinner, a private birthday bash, or a wedding reception, Chef Hernan delivers a show that guests in Carlsbad still talk about long after the event.
            </p>
            <ul className="space-y-3">
              {[
                'Corporate events & team building dinners',
                'Resort & hotel venue setups',
                'Birthday parties & milestone celebrations',
                'Wedding receptions & private dining',
                'HOA & community block events',
          ...
          <div className="space-y-4">
            <div className="p-8 rounded-2xl bg-zinc-900/50 border border-zinc-800">
              ...
              <p className="text-zinc-400">47 verified Google reviews — trusted by North County hosts</p>
            </div>
            <div className="grid grid-cols-2 gap-4">
              {[
                { stat: '14', label: 'Years Experience' },
                { stat: '1,000+', label: 'Events Catered' },
                { stat: 'North SD', label: 'County Coverage' },
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-zinc-400 text-lg max-w-xl mx-auto">
              Tell us about your Carlsbad event and we&apos;ll send a custom quote within 24 hours. No commitment required.
            </p>
          </div>
          <EventInquiryForm />
        </div>
      ...
      <SanDiegoLocations currentSlug="/san-diego/carlsbad" />
      <Footer />
    </div>
  )
}
