...
export default function EncintasPage() {
  return (
    <div className="min-h-screen bg-zinc-950">
      ...
      <section className="relative min-h-[60vh] flex items-center overflow-hidden bg-zinc-950 pt-20">
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-gradient-to-b from-black/70 via-black/50 to-zinc-950">
            <img src="/hero-bg-hibachi.jpg" alt="Hibachi Catering Encinitas" className="w-full h-full object-cover opacity-25" />
          </div>
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-8 py-20">
          <nav className="mb-6 text-sm text-zinc-500" aria-label="Breadcrumb">
            ...
            <span className="mx-2">›</span>
            <span className="text-zinc-300">Encinitas</span>
          </nav>
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-zinc-800 bg-zinc-900/50 mb-6">
            ...
            <span className="text-xs font-medium text-zinc-400 uppercase tracking-widest">Encinitas, San Diego County</span>
          </div>

          <h1 className="text-5xl md:text-6xl font-light text-zinc-100 leading-tight mb-4">
            Hibachi Catering in<br />
            <span className="bg-gradient-to-r from-red-500 to-red-700 bg-clip-text text-transparent font-normal">Encinitas, CA</span>
          </h1>

          <p className="text-xl text-zinc-300 max-w-2xl mb-8 leading-relaxed font-light">
            Bring the fire to Encinitas. Chef Hernan sets up the full hibachi experience at your backyard, beach venue, or private estate — perfect for the laid-back luxury lifestyle Encinitas is known for.
          </p>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-6">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-zinc-800 bg-zinc-900/50">
              <span className="text-xs font-medium text-zinc-400 uppercase tracking-widest">Why Encinitas Chooses Us</span>
            </div>
            <h2 className="text-4xl font-bold text-zinc-100">
              Private Hibachi Chef for<br />
              <span className="bg-gradient-to-r from-red-500 to-red-600 bg-clip-text text-transparent">Encinitas Events</span>
            </h2>
            <p className="text-zinc-400 text-lg leading-relaxed">
              Encinitas has some of the most incredible private event spaces in San Diego — oceanfront backyards, hillside estates, and beautiful beach venues. Fire Up Hibachi brings a cooking experience that matches the scenery. We set up wherever you need us and deliver an unforgettable show for your guests.
            </p>
            <ul className="space-y-3">
              {[
                'Beachfront & oceanfront dinner parties',
                'Backyard birthday parties & celebrations',
                'Wedding receptions & rehearsal dinners',
                'Private estate & luxury home events',
                'Graduation & milestone parties',
          ...
          <div className="space-y-4">
            <div className="p-8 rounded-2xl bg-zinc-900/50 border border-zinc-800">
              ...
              <p className="text-zinc-400">47 verified Google reviews — trusted across San Diego</p>
            </div>
            <div className="grid grid-cols-2 gap-4">
              {[
                { stat: '14', label: 'Years Experience' },
                { stat: '1,000+', label: 'Events Catered' },
                { stat: 'Beach OK', label: 'Outdoor Setups' },
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-zinc-400 text-lg max-w-xl mx-auto">
              Tell us about your Encinitas event and we&apos;ll send a custom quote within 24 hours. No commitment required.
            </p>
          </div>
          <EventInquiryForm />
        </div>
      ...
      <SanDiegoLocations currentSlug="/san-diego/encinitas" />
      <Footer />
    </div>
  )
}
