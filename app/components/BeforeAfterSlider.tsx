...
export const BeforeAfterSlider: React.FC<BeforeAfterSliderProps> = ({
  ...
  return (
    ...
    >
      ...
      >
        {/* Handle Circle */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-12 h-12 bg-white rounded-full shadow-lg flex items-center justify-center border-2 border-red-600 group-hover:scale-110 transition">
