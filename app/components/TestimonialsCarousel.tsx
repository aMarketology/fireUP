  ...
  return (
    <div className="w-full max-w-4xl mx-auto px-4">
      <div className="relative h-80 flex items-center justify-center">
        ...
        <button
          onClick={() => paginate(-1)}
          className="absolute left-0 z-10 -translate-x-12 md:-translate-x-16 w-10 h-10 bg-red-600 hover:bg-red-700 text-white rounded-full flex items-center justify-center transition shadow-lg"
        >
        ...
        <button
          onClick={() => paginate(1)}
          className="absolute right-0 z-10 translate-x-12 md:translate-x-16 w-10 h-10 bg-red-600 hover:bg-red-700 text-white rounded-full flex items-center justify-center transition shadow-lg"
        >
          <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
