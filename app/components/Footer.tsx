...
export default function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-b from-black to-zinc-950 text-white border-t border-white/10">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            >
              <div className="text-2xl font-bold leading-none mb-1">Fire Up</div>
              <div className="text-2xl font-bold leading-none">
                Hibachi <span className="text-red-600">Catering</span>
              </div>
            </motion.div>
        ...
        <div className="py-6 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-400">
          <p>&copy; 2025 Fire Up Hibachi Catering. All rights reserved.</p>
